 ...
 * `/pending`, `/account`, `/trainee/<id>` and `/trainee/<id>/mark/<code>`.
 ...
 * serverless invocation on every cold start. The other three are listed
 * because they cost nothing — the same bytes — and it means a first online
 * visit to any tab is static too.
 *
...
export function generateStaticParams() {
  return [{ slug: [] }, { slug: ['home'] }, { slug: ['pending'] }, { slug: ['account'] }];
}
