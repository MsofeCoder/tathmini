...
- [ ] Dexie outbox: idempotent UUID keys, exponential backoff, replay on reconnect — HANDOFF.md's narrower agreed cut is plain retry-on-reconnect, not full Background Sync; still unbuilt — a fully-offline submit attempt today fails visibly rather than queuing
